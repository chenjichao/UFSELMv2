function [X, W, y, A, evs, error] = AGUSELM2979(X, c, d, k, r, islocal, num_hidden_neurons,alpha,NITER)
...
error=0;
[clusternum, y]=conncomp(sparse(A)); y = y';
if clusternum ~= c
    warning('Can not find the correct cluster number: %d', c);
    error=1;
end;
end
